...
class CreatePostEntertainmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('post_entertainments', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('post_entertainments');
    }
}
