                    ...
                    <div class="contact_form_container">
                        ...
                        <form action="{{ route('register') }}" id="contact_form" method="post">
                            ...
                            <!--<div class="form-group">
                                ...
                                <input type="file" class="form-control" id="inputGroupFile01" name="photo" value="">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Gender </label>
                                <input type="text" class="form-control @error('gender') is-invalid @enderror" name="gender" value="{{ old('gender') }}"  aria-describedby="emailHelp" placeholder="Gender " required="">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Birthday </label>
                                <input type="date" class="form-control @error('birthday') is-invalid @enderror" name="birthday" value="{{ old('birthday') }}"  aria-describedby="emailHelp" placeholder="Birthday " required="">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Country </label>
                                <input type="text" class="form-control @error('country') is-invalid @enderror" name="country" value="{{ old('country') }}"  aria-describedby="emailHelp" placeholder="Country " required="">
                            </div>-->
                            <div class="form-group">
                                <label for="exampleInputEmail1">Password</label>
