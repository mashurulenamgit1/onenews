...
@endphp
    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
          ...
          <form action="{{ url('update/opipost/'.$post->id) }}" method="post" enctype="multipart/form-data">
          	@csrf
          ...
          <div class="form-layout">
            ...
            <span>Main Slider</span>
              ...
              <div class="col-lg-4">
                <label class="ckbox">
            <input type="checkbox" name="popular_slider" value="1" <?php if ($post->popular_slider == 1) {
              echo "checked";
            }?>>
            <span>Popular Slider</span>
          </label>
              </div>
              <div class="col-lg-4">
                <label class="ckbox">
            <input type="checkbox" name="popular_opinion" value="1" <?php if ($post->popular_opinion == 1) {
              echo "checked";
            }?>>
            <span>Popular Opinion</span>
          </label>
              </div>
              <div class="col-lg-4">
                <label class="ckbox">
            <input type="checkbox" name="general_opinion" value="1" <?php if ($post->general_opinion == 1) {
              echo "checked";
            }?>>
            <span>General Opinion</span>
          </label>
              </div>
              <div class="col-lg-4">
                <label class="ckbox">
            <input type="checkbox" name="related_opinion" value="1" <?php if ($post->related_opinion == 1) {
              echo "checked";
            }?>>
            <span>Related Opinion</span>
          </label>
              </div>
          </div>          
