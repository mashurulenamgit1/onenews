...
@section('admin_content')
    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
          ...
          <form action="{{ route('store.opipost') }}" method="post" enctype="multipart/form-data">
          	@csrf
          ...
          <div class="form-layout">
            ...
            <div class="row">
              ...
              <div class="col-lg-4">
                <label class="ckbox">
                <input type="checkbox" name="popular_slider" value="1">
                <span>Popular Slider</span>
              </label>
              </div><br>
              <div class="col-lg-4">
                <label class="ckbox">
                <input type="checkbox" name="popular_opinion" value="1">
                <span>Popular Opinion</span>
              </label>
              </div><br>
              <div class="col-lg-4">
                <label class="ckbox">
                <input type="checkbox" name="general_opinion" value="1">
                <span>General Opinion</span>
              </label>
              </div>
              <div class="col-lg-4">
                <label class="ckbox">
                <input type="checkbox" name="related_opinion" value="1">
